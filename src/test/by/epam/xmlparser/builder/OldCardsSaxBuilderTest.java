...
public class OldCardsSaxBuilderTest extends ExpectedDataSetup {

    OldCardsBuilder domBuilder = OldCardsCreator.getInstance().createBuilder(OldCardsCreator.ParserType.SAX);
