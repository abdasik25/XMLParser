...
public class OldCardsStaxBuilderTest extends ExpectedDataSetup {

    OldCardsBuilder domBuilder = OldCardsCreator.getInstance().createBuilder(OldCardsCreator.ParserType.STAX);
